...
CREATE TABLE `travels_on` (
  ...
  CONSTRAINT `travels_on_ibfk_1` FOREIGN KEY (`Route_ID`) REFERENCES `route` (`Route_ID`),
  CONSTRAINT `travels_on_ibfk_2` FOREIGN KEY (`Flight_ID`) REFERENCES `flight` (`Flight_ID`)
...
INSERT INTO `travels_on` VALUES (894521,'AA4367'),(168806,'AI2014'),(452368,'BA1689'),(578425,'CT7812'),(178916,'EY1234'),(324567,'LH9876'),(421523,'PF4521'),(157306,'QR2305');
